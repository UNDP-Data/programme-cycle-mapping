      ...
      <div className="App">
        ...
        </HeaderDiv>
        {
          ...
          <ProjectCycle
            ...
            erc={selectedSystem.indexOf('ERC') !== -1}
            powerBi={selectedSystem.indexOf('PowerBI') !== -1}
            unInfo={selectedSystem.indexOf('UNINFO') !== -1}
            UNDocs={selectedSystem.indexOf('UNDOCs') !== -1}
            website={selectedSystem.indexOf('UNSDG Website') !== -1}
            online={online}
            roles={selectedRoles}
